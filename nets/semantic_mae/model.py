...
class SemanticMAE(nn.Module):
    """ Masked Autoencoder with VisionTransformer backbone
    """

    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 embed_dim=128, depth=1, num_heads=16,
                 decoder_embed_dim=128, decoder_depth=1, decoder_num_heads=16,
                 mlp_ratio=4., norm_layer=nn.LayerNorm, norm_pix_loss=False):
        super().__init__()


        # Initial Linear Embedding for Input
        ...
        # Use ModuleList to properly register all blocks
        ...
        # --------------------------------------------------------------------------
        # MAE decoder specifics # Need to see where this is called
        ...
        # I guess we're still using a full-on transformer for the decoder.  Sure
